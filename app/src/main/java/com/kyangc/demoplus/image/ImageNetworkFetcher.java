 ...
 */
public class ImageNetworkFetcher extends BaseNetworkFetcher<FetchState> {
                    ...
                    public void run() {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                nextScheme = (nextUriString == null) ? null
                                        : Uri.parse(nextUriString).getScheme();
