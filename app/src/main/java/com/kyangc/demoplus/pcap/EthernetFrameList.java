...
/**
 * Simple list of ethernet packets that supports filtering and some basic statistical data.
 */
...
public class EthernetFrameList extends ArrayList<Packet<EthernetHeader>> {
     ...
     *
     * @return a subset of the list backed by this object that contains {@link
     * Packet<EthernetHeader>}s that fulfill all of the {@link Filter}s in {@code filters}
     */
